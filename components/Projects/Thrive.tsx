...
const stack = ["FastAPI", "React", "MongoDB", "TypeScript", "Python"];
const color = "#4ec9b0";
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <span>🌱</span>
              <span style={{ color, fontFamily: "'Fira Code', monospace", fontSize: "13px" }}>thrive</span>
          ...
          <div className="p-6 flex flex-col gap-5">
            <h2 className="text-2xl font-semibold" style={{ color: "#fff" }}>Thrive</h2>
            ...
            <div className="flex gap-3 pt-2">
              <a
                href="https://github.com/tahirbibic/Thrive"
                target="_blank"
                rel="noreferrer"
