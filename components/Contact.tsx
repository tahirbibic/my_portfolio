...
const contactLinks = [
  {
    key: "email",
    label: "email",
    value: "bibictahir@gmail.com",
    href: "mailto:bibictahir@gmail.com",
    color: "#ce9178",
    icon: (
  ...
  },
  {
    ...
    label: "github",
    value: "tahirbibic",
    href: "https://github.com/tahirbibic",
    color: "#d4d4d4",
    icon: (
  ...
  },
  {
    ...
    label: "linkedin",
    value: "tahir-bibić",
    href: "https://www.linkedin.com/in/tahir-bibi%C4%87-3584063b4/",
    color: "#569cd6",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-2" style={{ color: "#fff" }}>
            Let&apos;s{" "}
            <span style={{ color: "var(--vsc-purple)" }}>connect()</span>
          </h2>
          <p className="text-sm mb-8" style={{ color: "var(--vsc-text-dim)", lineHeight: "1.7" }}>
            I&apos;m always open to new projects, collaborations, or just talking tech.
              ...
              const inner = (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-xs" style={{ color: "var(--vsc-text-dim)", fontFamily: "'Fira Code', monospace" }}>
                      {link.label}:
                    </div>
                    <div className="text-sm" style={{ color: link.color, fontFamily: "'Fira Code', monospace" }}>
                      {link.value}
                    </div>
                  </div>
                  {link.href && (
                    <span style={{ color: "var(--vsc-text-dim)", fontSize: "12px" }}>↗</span>
                  )}
                </div>
              );
        ...
        <div
          ...
          style={{ border: "1px solid var(--vsc-border)", background: "#0d0d0d" }}
        >
          {/* Terminal bar */}
          <div
          ...
          <div
            className="p-5"
            style={{ fontFamily: "'Fira Code', monospace", fontSize: "13px", lineHeight: "1.8" }}
          >
            <div style={{ color: "#4ec9b0" }}>
              ...
              <span style={{ color: "#d4d4d4" }}>:~$ </span>
              <span style={{ color: "#d4d4d4" }}>node contact.js</span>
            </div>
            <div style={{ color: "var(--vsc-comment)", marginTop: "4px" }}>
              // Initializing contact module...
            </div>
            <div style={{ color: "#4ec9b0", marginTop: "4px" }}>
              ✓ Ready to connect
            </div>
            <div style={{ color: "var(--vsc-text-dim)", marginTop: "8px" }}>
              Contact info loaded:
            </div>
            <div style={{ color: "var(--vsc-cyan)", marginTop: "4px" }}>
              {"{"}<br />
              <span style={{ marginLeft: "16px" }} />{`  email: `}
              <span style={{ color: "#ce9178" }}>"bibictahir@gmail.com"</span>,<br />
              <span style={{ marginLeft: "16px" }} />{`  location: `}
              <span style={{ color: "#ce9178" }}>"Novi Pazar, RS"</span>,<br />
              <span style={{ marginLeft: "16px" }} />{`  available: `}
              <span style={{ color: "#569cd6" }}>true</span><br />
              {"}"}
            </div>

            <div style={{ marginTop: "16px", color: "var(--vsc-text-dim)" }}>
          ...
          <div
            ...
            style={{ borderTop: "1px solid var(--vsc-border)", background: "#111" }}
          >
      ...
      <div
        ...
        style={{ color: "var(--vsc-text-dim)", fontSize: "12px", fontFamily: "'Fira Code', monospace" }}
      >
        <span style={{ color: "var(--vsc-comment)", fontStyle: "italic" }}>
          {"// Built by Tahir Bibić · 2025 · VSCode theme because obviously"}
        </span>
      </div>
    </section>
  );
